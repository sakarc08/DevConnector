...
const AddEducation = ({ addEducation, history }) => {
    ...
    return (
      ...
      <p class="lead">
        <i class="fas fa-code-branch"></i> Add any school/bootcamp that you had attended in the past
      </p>
      ...
      <form class="form" onSubmit={(e) => {
        ...
        <div class="form-group">
          <input type="text" placeholder="* Add School" name="school" required value={school} onChange={(e) => onChange(e)} />
        </div>
        <div class="form-group">
